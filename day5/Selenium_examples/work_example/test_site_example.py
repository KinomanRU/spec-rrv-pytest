...
class PriceTestCase(unittest.TestCase):
    savePath = "E:\\Documents\\Downloads\\"
    ...
    def setUp(self):
        ...
        self.page = self.driver.get("https://service-online.su/forms/cenniki/")
        ...
        elem.click()
        elem = self.driver.find_element(By.NAME, "soglasie2")
        elem.click()
    ...
    def testOnePriceRu(self):
        ...
        today = datetime.date.today()
        fullpath = (
            self.savePath + "cenniki_new-" + today.strftime("%Y-%m-%d") + "-1.pdf"
        )
        self.assertEqual(os.path.isfile(fullpath), True)
